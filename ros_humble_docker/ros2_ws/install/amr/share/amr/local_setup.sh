...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/install/amr"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/amr/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/amr/environment/path.sh"
