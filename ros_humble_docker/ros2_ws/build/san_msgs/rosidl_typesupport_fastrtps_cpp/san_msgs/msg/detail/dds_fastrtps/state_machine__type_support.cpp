...
#include "san_msgs/msg/detail/state_machine__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = san_msgs::msg::StateMachine;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const san_msgs::msg::StateMachine *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<san_msgs::msg::StateMachine *>(
    untyped_ros_message);
...
{
  return &san_msgs::msg::typesupport_fastrtps_cpp::_StateMachine__handle;
}
