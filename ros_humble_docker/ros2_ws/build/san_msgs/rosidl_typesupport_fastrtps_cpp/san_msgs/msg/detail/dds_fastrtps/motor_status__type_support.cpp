...
#include "san_msgs/msg/detail/motor_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const san_msgs::msg::MotorStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  san_msgs::msg::MotorStatus & ros_message)
{
  // Member: state
  cdr >> ros_message.state;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = san_msgs::msg::MotorStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const san_msgs::msg::MotorStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<san_msgs::msg::MotorStatus *>(
    untyped_ros_message);
...
{
  return &san_msgs::msg::typesupport_fastrtps_cpp::_MotorStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, san_msgs, msg, MotorStatus)() {
  return &san_msgs::msg::typesupport_fastrtps_cpp::_MotorStatus__handle;
}
