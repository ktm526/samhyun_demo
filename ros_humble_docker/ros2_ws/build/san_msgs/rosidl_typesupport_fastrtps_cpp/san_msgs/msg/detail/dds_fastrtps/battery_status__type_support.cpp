...
#include "san_msgs/msg/detail/battery_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const san_msgs::msg::BatteryStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  san_msgs::msg::BatteryStatus & ros_message)
{
  // Member: voltage_top
  cdr >> ros_message.voltage_top;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = san_msgs::msg::BatteryStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const san_msgs::msg::BatteryStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<san_msgs::msg::BatteryStatus *>(
    untyped_ros_message);
...
{
  return &san_msgs::msg::typesupport_fastrtps_cpp::_BatteryStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, san_msgs, msg, BatteryStatus)() {
  return &san_msgs::msg::typesupport_fastrtps_cpp::_BatteryStatus__handle;
}
