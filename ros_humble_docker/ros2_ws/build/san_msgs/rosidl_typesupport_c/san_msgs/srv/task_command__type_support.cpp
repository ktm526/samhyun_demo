...
static const _TaskCommand_Request_type_support_symbol_names_t _TaskCommand_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, san_msgs, srv, TaskCommand_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, san_msgs, srv, TaskCommand_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, san_msgs, srv, TaskCommand_Request)() {
  return &::san_msgs::srv::rosidl_typesupport_c::TaskCommand_Request_message_type_support_handle;
}
...
static const _TaskCommand_Response_type_support_symbol_names_t _TaskCommand_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, san_msgs, srv, TaskCommand_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, san_msgs, srv, TaskCommand_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, san_msgs, srv, TaskCommand_Response)() {
  return &::san_msgs::srv::rosidl_typesupport_c::TaskCommand_Response_message_type_support_handle;
}
...
static const _TaskCommand_type_support_symbol_names_t _TaskCommand_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, san_msgs, srv, TaskCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, san_msgs, srv, TaskCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, san_msgs, srv, TaskCommand)() {
  return &::san_msgs::srv::rosidl_typesupport_c::TaskCommand_service_type_support_handle;
}
