...
#include "san_msgs/msg/detail/motor_status__rosidl_typesupport_fastrtps_c.h"
...
using _MotorStatus__ros_msg_type = san_msgs__msg__MotorStatus;
...
static uint32_t _MotorStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_san_msgs__msg__MotorStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = san_msgs__msg__MotorStatus;
    is_plain =
      (
...
static size_t _MotorStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_san_msgs__msg__MotorStatus(
