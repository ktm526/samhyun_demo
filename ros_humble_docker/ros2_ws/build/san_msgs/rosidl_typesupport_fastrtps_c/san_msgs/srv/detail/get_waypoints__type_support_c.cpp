...
#include "san_msgs/srv/detail/get_waypoints__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // node_file
#include "rosidl_runtime_c/string_functions.h"  // node_file

// forward declare type support functions


using _GetWaypoints_Request__ros_msg_type = san_msgs__srv__GetWaypoints_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: node_file
  {
    const rosidl_runtime_c__String * str = &ros_message->node_file;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: node_file
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->node_file.data) {
      rosidl_runtime_c__String__init(&ros_message->node_file);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->node_file,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'node_file'\n");
      return false;
    }
  }
...
size_t get_serialized_size_san_msgs__srv__GetWaypoints_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetWaypoints_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_san_msgs__srv__GetWaypoints_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_san_msgs
size_t max_serialized_size_san_msgs__srv__GetWaypoints_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = san_msgs__srv__GetWaypoints_Request;
    is_plain =
      (
...
static size_t _GetWaypoints_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_san_msgs__srv__GetWaypoints_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, san_msgs, srv, GetWaypoints_Request)() {
...
#include "rosidl_runtime_c/primitives_sequence.h"  // node_path
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // node_path
// already included above
...
using _GetWaypoints_Response__ros_msg_type = san_msgs__srv__GetWaypoints_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: node_path
  {
    size_t size = ros_message->node_path.size;
    auto array_ptr = ros_message->node_path.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: node_path
  {
    ...
    if (ros_message->node_path.data) {
      rosidl_runtime_c__uint16__Sequence__fini(&ros_message->node_path);
    }
    if (!rosidl_runtime_c__uint16__Sequence__init(&ros_message->node_path, size)) {
      fprintf(stderr, "failed to create array for field 'node_path'");
      return false;
    }
    auto array_ptr = ros_message->node_path.data;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_san_msgs
size_t get_serialized_size_san_msgs__srv__GetWaypoints_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetWaypoints_Response__ros_msg_type * ros_message = static_cast<const _GetWaypoints_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_san_msgs__srv__GetWaypoints_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_san_msgs
size_t max_serialized_size_san_msgs__srv__GetWaypoints_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = san_msgs__srv__GetWaypoints_Response;
    is_plain =
      (
...
static size_t _GetWaypoints_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_san_msgs__srv__GetWaypoints_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, san_msgs, srv, GetWaypoints_Response)() {
...
// already included above
// #include "san_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "san_msgs/srv/get_waypoints.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, san_msgs, srv, GetWaypoints)() {
