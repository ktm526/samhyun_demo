...
#ifndef SAN_MSGS__SRV__DETAIL__TASK_COMMAND__FUNCTIONS_H_
#define SAN_MSGS__SRV__DETAIL__TASK_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * san_msgs__srv__TaskCommand_Request__init().
...
/**
 * It calls
 * san_msgs__srv__TaskCommand_Request__fini()
 ...
 * san_msgs__srv__TaskCommand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * san_msgs__srv__TaskCommand_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * san_msgs__srv__TaskCommand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_san_msgs
...
/**
 * It calls
 * san_msgs__srv__TaskCommand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_san_msgs
...
/**
 * It allocates the memory for the array and calls
 * san_msgs__srv__TaskCommand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_san_msgs
...
/**
 * It calls
 * san_msgs__srv__TaskCommand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SAN_MSGS__SRV__DETAIL__TASK_COMMAND__FUNCTIONS_H_
