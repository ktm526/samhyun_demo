...
#ifndef SAN_MSGS__SRV__DETAIL__BUILD_MAP__FUNCTIONS_H_
#define SAN_MSGS__SRV__DETAIL__BUILD_MAP__FUNCTIONS_H_
...
/// Initialize srv/BuildMap message.
/**
...
/// Create srv/BuildMap message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * san_msgs__srv__BuildMap_Request__init().
...
/// Destroy srv/BuildMap message.
/**
 * It calls
 * san_msgs__srv__BuildMap_Request__fini()
...
/// Check for srv/BuildMap message equality.
/**
...
/// Initialize array of srv/BuildMap messages.
/**
...
/// Finalize array of srv/BuildMap messages.
/**
 * It calls
 * san_msgs__srv__BuildMap_Request__fini()
...
/// Create array of srv/BuildMap messages.
/**
 * It allocates the memory for the array and calls
 * san_msgs__srv__BuildMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/BuildMap messages.
/**
 * It calls
 * san_msgs__srv__BuildMap_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/BuildMap message array equality.
/**
...
/// Copy an array of srv/BuildMap messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * san_msgs__srv__BuildMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_san_msgs
...
/**
 * It calls
 * san_msgs__srv__BuildMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_san_msgs
...
/**
 * It allocates the memory for the array and calls
 * san_msgs__srv__BuildMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_san_msgs
...
/**
 * It calls
 * san_msgs__srv__BuildMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SAN_MSGS__SRV__DETAIL__BUILD_MAP__FUNCTIONS_H_
