...
san_msgs__srv__SlamMode_Request__are_equal(const san_msgs__srv__SlamMode_Request * lhs, const san_msgs__srv__SlamMode_Request * rhs)
{
  ...
  // slam_start
  if (lhs->slam_start != rhs->slam_start) {
    return false;
  }
  return true;
}
  ...
  san_msgs__srv__SlamMode_Request * output)
{
  ...
  // slam_start
  output->slam_start = input->slam_start;
  return true;
}
...
san_msgs__srv__SlamMode_Request__create()
{
  ...
  san_msgs__srv__SlamMode_Request * msg = (san_msgs__srv__SlamMode_Request *)allocator.allocate(sizeof(san_msgs__srv__SlamMode_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(san_msgs__srv__SlamMode_Request));
  bool success = san_msgs__srv__SlamMode_Request__init(msg);
  if (!success) {
...
san_msgs__srv__SlamMode_Request__destroy(san_msgs__srv__SlamMode_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    san_msgs__srv__SlamMode_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
san_msgs__srv__SlamMode_Request__Sequence__init(san_msgs__srv__SlamMode_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  san_msgs__srv__SlamMode_Request * data = NULL;

  if (size) {
    data = (san_msgs__srv__SlamMode_Request *)allocator.zero_allocate(size, sizeof(san_msgs__srv__SlamMode_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = san_msgs__srv__SlamMode_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        san_msgs__srv__SlamMode_Request__fini(&data[i - 1]);
      }
...
san_msgs__srv__SlamMode_Request__Sequence__fini(san_msgs__srv__SlamMode_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      san_msgs__srv__SlamMode_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  san_msgs__srv__SlamMode_Request__Sequence * array = (san_msgs__srv__SlamMode_Request__Sequence *)allocator.allocate(sizeof(san_msgs__srv__SlamMode_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = san_msgs__srv__SlamMode_Request__Sequence__init(array, size);
  if (!success) {
...
san_msgs__srv__SlamMode_Request__Sequence__destroy(san_msgs__srv__SlamMode_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    san_msgs__srv__SlamMode_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
san_msgs__srv__SlamMode_Request__Sequence__are_equal(const san_msgs__srv__SlamMode_Request__Sequence * lhs, const san_msgs__srv__SlamMode_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!san_msgs__srv__SlamMode_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  san_msgs__srv__SlamMode_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(san_msgs__srv__SlamMode_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    san_msgs__srv__SlamMode_Request * data =
      (san_msgs__srv__SlamMode_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!san_msgs__srv__SlamMode_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          san_msgs__srv__SlamMode_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!san_msgs__srv__SlamMode_Request__copy(
...
san_msgs__srv__SlamMode_Response__init(san_msgs__srv__SlamMode_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    san_msgs__srv__SlamMode_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  san_msgs__srv__SlamMode_Response * msg = (san_msgs__srv__SlamMode_Response *)allocator.allocate(sizeof(san_msgs__srv__SlamMode_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(san_msgs__srv__SlamMode_Response));
  bool success = san_msgs__srv__SlamMode_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
san_msgs__srv__SlamMode_Response__Sequence__init(san_msgs__srv__SlamMode_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  san_msgs__srv__SlamMode_Response * data = NULL;

  if (size) {
    data = (san_msgs__srv__SlamMode_Response *)allocator.zero_allocate(size, sizeof(san_msgs__srv__SlamMode_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = san_msgs__srv__SlamMode_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        san_msgs__srv__SlamMode_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
san_msgs__srv__SlamMode_Response__Sequence__fini(san_msgs__srv__SlamMode_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      san_msgs__srv__SlamMode_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  san_msgs__srv__SlamMode_Response__Sequence * array = (san_msgs__srv__SlamMode_Response__Sequence *)allocator.allocate(sizeof(san_msgs__srv__SlamMode_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = san_msgs__srv__SlamMode_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
san_msgs__srv__SlamMode_Response__Sequence__destroy(san_msgs__srv__SlamMode_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    san_msgs__srv__SlamMode_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
san_msgs__srv__SlamMode_Response__Sequence__are_equal(const san_msgs__srv__SlamMode_Response__Sequence * lhs, const san_msgs__srv__SlamMode_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!san_msgs__srv__SlamMode_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  san_msgs__srv__SlamMode_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(san_msgs__srv__SlamMode_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    san_msgs__srv__SlamMode_Response * data =
      (san_msgs__srv__SlamMode_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!san_msgs__srv__SlamMode_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          san_msgs__srv__SlamMode_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!san_msgs__srv__SlamMode_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
