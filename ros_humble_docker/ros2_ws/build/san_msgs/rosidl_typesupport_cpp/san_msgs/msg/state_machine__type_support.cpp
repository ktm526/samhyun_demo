...
static const _StateMachine_type_support_symbol_names_t _StateMachine_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, san_msgs, msg, StateMachine)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, san_msgs, msg, StateMachine)),
  }
};
...
{
  return &::san_msgs::msg::rosidl_typesupport_cpp::StateMachine_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, san_msgs, msg, StateMachine)() {
  return get_message_type_support_handle<san_msgs::msg::StateMachine>();
}
