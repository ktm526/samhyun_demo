...
static const _BatteryStatus_type_support_symbol_names_t _BatteryStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, san_msgs, msg, BatteryStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, san_msgs, msg, BatteryStatus)),
  }
};
...
get_message_type_support_handle<san_msgs::msg::BatteryStatus>()
{
  return &::san_msgs::msg::rosidl_typesupport_cpp::BatteryStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, san_msgs, msg, BatteryStatus)() {
  return get_message_type_support_handle<san_msgs::msg::BatteryStatus>();
}
