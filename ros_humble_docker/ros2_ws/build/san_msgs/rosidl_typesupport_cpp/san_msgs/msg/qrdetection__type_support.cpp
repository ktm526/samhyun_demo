...
static const _Qrdetection_type_support_symbol_names_t _Qrdetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, san_msgs, msg, Qrdetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, san_msgs, msg, Qrdetection)),
  }
};
...
{
  return &::san_msgs::msg::rosidl_typesupport_cpp::Qrdetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, san_msgs, msg, Qrdetection)() {
  return get_message_type_support_handle<san_msgs::msg::Qrdetection>();
}
