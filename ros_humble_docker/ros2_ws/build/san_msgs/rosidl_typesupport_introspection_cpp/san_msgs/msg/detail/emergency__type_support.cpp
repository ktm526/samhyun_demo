...
{
  new (message_memory) san_msgs::msg::Emergency(_init);
}

void Emergency_fini_function(void * message_memory)
{
  auto typed_message = static_cast<san_msgs::msg::Emergency *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Emergency_message_member_array[1] = {
  {
    ...
    offsetof(san_msgs::msg::Emergency, emergency),  // bytes offset in struct
...
{
  return &::san_msgs::msg::rosidl_typesupport_introspection_cpp::Emergency_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, san_msgs, msg, Emergency)() {
  return &::san_msgs::msg::rosidl_typesupport_introspection_cpp::Emergency_message_type_support_handle;
}
