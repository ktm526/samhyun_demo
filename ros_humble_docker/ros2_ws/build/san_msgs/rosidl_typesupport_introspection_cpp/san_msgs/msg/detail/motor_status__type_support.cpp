...
{
  new (message_memory) san_msgs::msg::MotorStatus(_init);
}

void MotorStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<san_msgs::msg::MotorStatus *>(message_memory);
  typed_message->~MotorStatus();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorStatus_message_member_array[1] = {
  {
    "state",  // name
    ...
    offsetof(san_msgs::msg::MotorStatus, state),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(san_msgs::msg::MotorStatus),
...
get_message_type_support_handle<san_msgs::msg::MotorStatus>()
{
  return &::san_msgs::msg::rosidl_typesupport_introspection_cpp::MotorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, san_msgs, msg, MotorStatus)() {
  return &::san_msgs::msg::rosidl_typesupport_introspection_cpp::MotorStatus_message_type_support_handle;
}
