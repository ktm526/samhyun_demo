    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'san_msgs.msg.Qrdetection')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__qrdetection
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__qrdetection
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__qrdetection
            cls._TYPE_SUPPORT = module.type_support_msg__msg__qrdetection
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__qrdetection
...
class Qrdetection(metaclass=Metaclass_Qrdetection):
    ...
    def __init__(self, **kwargs):
        ...
        self.cam_num = kwargs.get('cam_num', int())
    ...
    @builtins.property
    def cam_num(self):
        """Message field 'cam_num'."""
        return self._cam_num

    @cam_num.setter
    def cam_num(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'cam_num' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'cam_num' field must be an integer in [-2147483648, 2147483647]"
        self._cam_num = value
