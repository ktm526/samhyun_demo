      ...
      >
        {stlModel?.geometry ? (
          <>
            ...
            {/* 방향 표시용 작은 누운 사각뿔 - 상태 색상, STL 앞쪽(지면 위)에 배치 */}
            <mesh
